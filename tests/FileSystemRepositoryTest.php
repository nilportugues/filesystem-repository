 ...
 */
namespace NilPortugues\Tests\Foundation\Infrastructure\Model\Repository\FileSystem;
...
class FileSystemRepositoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $baseDir = __DIR__.self::DATABASE_DIR;
        if (!file_exists($baseDir)) {
            mkdir($baseDir, 0755, true);
        }

        $fileSystem = new NativeFileSystem($baseDir);
        $this->repository = new FileSystemRepository($fileSystem);
